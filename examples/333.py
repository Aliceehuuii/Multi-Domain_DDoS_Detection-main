...
def myNetwork():
    ...
    h1.cmd('tcpdump -i h1-eth0 -w normal_traffic_a.pcap &')
    h1.cmd('tcpdump -i h1-eth0 -w attack_traffic_a.pcap &')
    #r2.cmd('tcpdump -i r2-eth0 -w attack_traffic22.pcap &')
    r3.cmd('tcpdump -i r3-eth0 -w traffic_a.pcap &')
    ...
    while time.time() - start_time <= duration:
        ...
        if random.random() < normal_traffic:
           ...
           h1.cmd('hping3 -c 100 -S -w 64 -p 80 --flood --rand-source 10.0.10.3')
        time.sleep(1)
